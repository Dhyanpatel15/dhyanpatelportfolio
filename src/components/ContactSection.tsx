...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'dhyanpatel1509@gmail.com',
    href: 'https://mail.google.com/',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 79844 25791',
    // wa.me requires digits only — no +, no spaces, no hyphens
    href: 'https://wa.me/917984425791',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/dhyan-patel-9a760b213',
    href: 'https://www.linkedin.com/in/dhyan-patel-9a760b213/?skipRedirect=true',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Dhyanpatel15',
    href: 'https://github.com/Dhyanpatel15',
  },
];
