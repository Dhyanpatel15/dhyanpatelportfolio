...
const ABOUT_TEXT =
  "I'm a Computer Science graduate from GTU, Currentlly working as a Python Developer at REDEL Sourcing Ltd will give you valuable hands-on experience";
                      ...
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          ...
                          },
                          {
                            ...
                            items: ['Django', 'Flask', 'Pandas', 'NumPy', 'Scikit-learn', 'NLTK'],
                          },
                          {
                            label: 'Tools & Platforms',
                            items: ['VSCode', 'Vercel', 'Git', 'GitHub', 'Pycharm', 'Canva', 'Excel'],
                          },
                          {
                            label: 'AI & GenAI',
